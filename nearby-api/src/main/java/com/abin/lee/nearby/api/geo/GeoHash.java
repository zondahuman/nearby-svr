package com.abin.lee.nearby.api.geo;
...
public class GeoHash {
    ...
    public static void main(String[] args) {
        ...
        GeoHash geoHash = new GeoHash(40.222012, 116.248283);
        System.out.println(geoHash.getGeoHashBase32());
        System.out.println(JsonUtil.toJson(geoHash.getGeoHashBase32For9()));
    }
